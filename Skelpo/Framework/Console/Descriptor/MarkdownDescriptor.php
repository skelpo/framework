...
class MarkdownDescriptor extends Descriptor
{
	...
	protected function describeRouteCollection(RouteCollection $routes, array $options = array())
	{
		...
		foreach ($routes->all() as $name => $route)
		{
			...
			$this->describeRoute($route, array(
					'name' => $name 
			));
		}
		$this->write("\n");
	...
	protected function describeContainerTags(ContainerBuilder $builder, array $options = array())
	{
		...
		foreach ($this->findDefinitionsByTag($builder, $showPrivate) as $tag => $definitions)
		{
			...
			{
				$this->write("\n\n");
				$this->describeContainerDefinition($definition, array(
						'omit_tags' => true,
						'id' => $serviceId 
				));
			}
	...
	protected function describeContainerServices(ContainerBuilder $builder, array $options = array())
	{
		...
		if (! empty($services['definitions']))
		{
			...
			{
				$this->write("\n");
				$this->describeContainerDefinition($service, array(
						'id' => $id 
				));
			}
		}
		...
		if (! empty($services['aliases']))
		{
			...
			{
				$this->write("\n");
				$this->describeContainerAlias($service, array(
						'id' => $id 
				));
			}
		}
